                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('update.district', $district->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control text-white" name="district_en"   rows="5" placeholder="District English">{{ $district->district_en}}</textarea>
                            @error('district_en')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control text-white" name="district_nep" id="district_en" rows="5" placeholder="District Nepali">{{ $district->district_nep}}</textarea>
                            @error('district_nep')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
