            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="template-demo">
                        <a href="{{ route('add.website')}}"><button class="btn btn-primary btn-fw m-2" type="button" style="float: right">Add Website Link</button></a>
                    </div>
                                ...
                                @foreach ($website as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('delete.website', $row->id) }}" onclick="return confirm('Are you Sure Want to Delete?')" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
